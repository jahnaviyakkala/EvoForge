...
double scientifc_calc_add(double a, double b) { return a + b; }
double scientifc_calc_subtract(double a, double b) { return a - b; }
double scientifc_calc_multiply(double a, double b) { return a * b; }
