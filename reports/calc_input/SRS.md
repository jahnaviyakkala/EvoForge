...
- [NEW] The system shall provide primary operations for Calc_input.
- [NEW] The system shall support inspection and status queries for Calc_input.
...
- [NEW] The implementation shall use idiomatic, standards-compliant C++.
