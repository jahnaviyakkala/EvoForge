...
- [NEW] The system shall provide a high-performance, standards-compliant Generate_calcualtor component written in C++.
...
- [NEW] The system shall provide primary operations for the Generate_calcualtor data module.
