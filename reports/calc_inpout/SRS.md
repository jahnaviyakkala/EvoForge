...
- [NEW] The system shall provide a high-performance, standards-compliant Calc_inpout component written in C++.
...
- [NEW] The system shall provide primary operations for the Calc_inpout data module.
