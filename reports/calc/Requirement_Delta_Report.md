...
- [NEW] The system shall provide a fully functional, robust, and extensible Calc application in Python.
...
- [NEW] The system shall implement core operational routines for Calc.
...
- [NEW] The system shall include an automated Pytest test suite (`tests/test_calc.py`) covering positive, negative, and edge-case execution paths.
