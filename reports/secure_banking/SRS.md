...
- [NEW] The system shall provide a high-performance, standards-compliant Secure Banking application written in C.
- [NEW] Specification Prompt: "Create a secure banking system in C
- [NEW] with account creation, transaction ledger, OpenSSL‑based data encryption, pthread‑based
- [NEW] concurrency, robust input validation, and a CMocka unit‑test suite; generate .c/.h files,
- [NEW] a Makefile, and test runner."
...
- [NEW] The system shall execute functional logic satisfying: Create a secure banking system in C
- [NEW] with account creation, transaction ledger, OpenSSL‑based data encryption, pthread‑based
- [NEW] concurrency, robust input validation, and a CMocka unit‑test suite; generate .c/.h files,
- [NEW] a Makefile, and test runner..
